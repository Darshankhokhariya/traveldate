                    ...
                    <div className="modal-container mx-3 md:mx-auto bg-white  w-full sm:max-w-xl  md:rounded-3xl rounded-2xl shadow-lg z-50 overflow-y-auto">
                        <div className="modal-content py-4 text-left px-6">
                            ...
                            <div className='w-full'>
                                <div className='w-full sm:w-[50%] flex flex-col items-center mx-auto'>
                                    ...
                                    <button class="flex w-full items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-3xl bg-white  ">
                                        ...
                                        <span class=" px-4 py-3 font-bold text-center text-xs md:text-sm">Sign in with Google</span>
                                    </button>
                                    ...
                                    <div class="flex w-full font-semibold items-center gap-2 py-4 text-sm text-slate-600">
                                    ...
                                    <div class="flex w-full items-center justify-center  md:gap-8 gap-6  py-4 text-sm text-slate-600">
                                        <div className='flex justify-center'>
                                            <button className='bg-[#f5435a] py-3 px-7 md:px-9 text-xs md:text-sm font-semibold text-white rounded-3xl '>Register</button>
                                        </div>
                                        <div className=' flex justify-center'>
                                            <button className='bg-gray-200 py-3 text-black px-7 md:px-9 font-semibold text-xs md:text-sm  rounded-3xl'>Login</button>
                                        </div>
                                    </div>
