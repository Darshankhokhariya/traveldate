  ...
  return (
    <>
      <div className="md:p-2">
        <footer className="md:p-4 overflow-hidden footer ">
              ...
              <div class="container md:px-6 py-12 mx-auto">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                  <div class="col-span-2">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="py-5 flex md:hidden gap-2">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M16 0.635742C7.1808 0.635742 0 7.81654 0 16.6357C0 25.4549 7.1808 32.6357 16 32.6357C24.8192 32.6357 32 25.4613 32 16.6357C32 7.81014 24.8256 0.635742 16 0.635742ZM20.4352 10.1269C20.4352 10.2613 20.3264 10.3701 20.192 10.3701H18.2656C17.792 10.3701 17.408 10.7541 17.408 11.2277V13.2437H20.1472C20.1536 13.2437 20.16 13.2437 20.1664 13.2437C20.3008 13.2565 20.3968 13.3717 20.384 13.5061L20.1408 16.3477C20.128 16.4757 20.0256 16.5717 19.8976 16.5717H17.4016V25.9989C17.4016 26.1333 17.2928 26.2421 17.1584 26.2421H13.7152C13.5808 26.2421 13.472 26.1333 13.472 25.9989V16.7125V16.5589H11.7504C11.616 16.5589 11.5072 16.4501 11.5072 16.3157V13.4741C11.5072 13.3397 11.616 13.2309 11.7504 13.2309H13.472V10.4917C13.472 8.58454 15.0208 7.03574 16.928 7.03574H20.1792C20.3136 7.03574 20.4224 7.14454 20.4224 7.27894V10.1269H20.4352Z"
                            fill="#F4425A"
                          />
                        </svg>
                        {/* <svg
                    ...
                    <div className="py-5 hidden md:flex gap-2">
                      <svg
                        width="32"
                        height="33"
                        viewBox="0 0 32 33"
