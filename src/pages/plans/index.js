        ...
        <div className="px-5 pb-20  md:px-16">
          <div className="lg:flex justify-center w-full ">
            <div className="relative w-full">
              <img
                className="w-full h-[450px] md:h-[300px] rounded-3xl"
                src="/images1/plans.png"
                alt=""
              />

              <div className="absolute top-1/2 -translate-y-1/2 text-white px-10 flex flex-col md:flex-row justify-between items-start md:items-center w-full h-full">
                <div className="py-4">
                  <h1 className="text-[32px]">Save More</h1>
                  <h1 className="text-[32px] font-bold">With Goodplans.</h1>
                  <p className="text-lg py-4">
                    Choose a plan and get onboard in{" "}
                    <br className="hidden md:block" /> minutes.{" "}
                  </p>
                </div>
                <div className="">
                  <svg
                ...
                <div className="md:mt-6 -ml-10 md:ml-0">
          ...
          <div className="flex flex-col  md:flex-row  justify-center h-max py-10 gap-4">
            {/* card1 */}

            <div className=" py-8  shadow-lg px-8 bg-white rounded-xl flex flex-col justify-between items-center">
              <div>
              ...
              <button
                type="button"
                className="rounded-xl border mt-20 md:mt-0 px-3 py-3 w-full  text-sm font-semibold  shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-primary text-white"
              >
                Choose
              </button>
            </div>
            ...
            <div className=" py-8  px-8 bg-primary  text-white rounded-xl  flex flex-col justify-between items-center">
              <div>
                <div className="flex items-center gap-5 ">
                  <svg
                    width="34"
                  ...
                  <h1 className="text-[32px] font-bold text-white">Advaced</h1>
                </div>
              ...
              <button
                type="button"
                className="rounded-xl border  px-3 py-3 w-full  text-sm font-semibold  shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-white text-primary  mt-20"
              >
                Choose
              </button>
            </div>
